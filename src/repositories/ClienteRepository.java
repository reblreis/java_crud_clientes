...
public class ClienteRepository {
	...
	public void delete(Cliente cliente) throws Exception {
		...
		// escrevendo um comando em linguagem SQL para excluir um cliente no banco de
		// dados
	...
	// método para consultar todos os cliente no banco de dados
	public List<Cliente> findAll() throws Exception {
		...
		// escrevendo um comando em linguagem SQL para consultar todos os cliente
		PreparedStatement statement = connection.prepareStatement("select * from cliente ");
		ResultSet resultSet = statement.executeQuery();

		// declarando um listagem de clientes
